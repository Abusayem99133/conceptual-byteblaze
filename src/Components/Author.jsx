...
const Author = () => {
  ...
  return (
    <div className="flex flex-col w-full p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
      <img
        src={profile_image}
        alt=""
      ...
      <div className="space-y-4 text-center divide-y divide-gray-700 dark:divide-gray-300">
        ...
        <div className="flex justify-center pt-2 space-x-4 align-center">
          ...
          <a
            target="_blank"
            href={`https://google.com/${website_url}`}
            aria-label="Dribble"
            className="p-2 rounded-md text-gray-100 dark:text-gray-800 hover:text-violet-400 hover:dark:text-violet-600"
          >
            <svg
          ...
          <a
            target="_blank"
            href={`https://twitter.com/${twitter_usename}`}
            aria-label="Twitter"
            className="p-2 rounded-md text-gray-100 dark:text-gray-800 hover:text-violet-400 hover:dark:text-violet-600"
          >
            <svg
